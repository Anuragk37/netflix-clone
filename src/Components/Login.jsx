...
const Login = () => {
  ...
  return (
      ...
      <form onSubmit={(e)=>e.preventDefault()} className='w-3/12 absolute bg-black bg-opacity-80 mx-auto left-0 right-0 my-36 p-12 text-white' action="">
         ...
         {isLogin?null:<input ref={fullName} type='text' placeholder='Full name' className='h-12 p-2 my-3 w-full bg-gray-700 bg-opacity-30 rounded-md border-2 border-gray-400'/>}
